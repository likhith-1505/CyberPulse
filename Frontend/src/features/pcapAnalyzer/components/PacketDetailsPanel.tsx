...
export function PacketDetailsPanel() {
  ...
  const layers: Record<string, PacketLayerField[]> = {
    ...
    ethernet: [
      { name: "Destination MAC", value: "00:00:00:00:00:00", type: "hex" },
      { name: "Source MAC", value: "00:00:00:00:00:01", type: "hex" },
      { name: "Type", value: "IPv4 (0x0800)", type: "hex" },
    ],
    ipv4: [
      ...
      { name: "Identification", value: "0x1234", type: "hex" },
      ...
      { name: "Header Checksum", value: "0x5678", type: "hex" },
    ...
    transport: [
      ...(selectedPacket.protocol === "TCP"
        ? [
            ...
            { name: "Sequence Number", value: "1000", type: "hex" },
            { name: "Acknowledgment Number", value: "2000", type: "hex" },
            { name: "Header Length", value: "20 bytes" },
            { name: "Flags", value: selectedPacket.flags?.join(", ") || "None" },
            { name: "Window Size", value: "65535" },
            { name: "Checksum", value: "0xabcd", type: "hex" },
          ]
        : [
            { name: "Source Port", value: "53636" },
            { name: "Destination Port", value: "53" },
            { name: "Length", value: selectedPacket.length.toString() },
            { name: "Checksum", value: "0x9999", type: "hex" },
          ]),
    ],
  };
